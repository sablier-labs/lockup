...
abstract contract Claim_Integration_Test is Integration_Test {
    ...
    function test_RevertGiven_MsgValueLessThanFee() external givenCampaignNotExpired {
        vm.expectRevert(
            abi.encodeWithSelector(Errors.SablierMerkleBase_InsufficientFeePayment.selector, 0, MINIMUM_FEE_IN_WEI)
        );
    ...
    function test_RevertGiven_RecipientClaimed() external givenCampaignNotExpired givenMsgValueNotLessThanFee {
        ...
        merkleBase.claim{ value: MINIMUM_FEE_IN_WEI }(INDEX1, users.recipient1, CLAIM_AMOUNT, index1Proof());
    }
        ...
        givenRecipientNotClaimed
    {
        ...
        merkleBase.claim{ value: MINIMUM_FEE_IN_WEI }(invalidIndex, users.recipient1, CLAIM_AMOUNT, index1Proof());
    }
        ...
        whenIndexValid
    {
        ...
        vm.expectRevert(Errors.SablierMerkleBase_InvalidProof.selector);
        merkleBase.claim{ value: MINIMUM_FEE_IN_WEI }(INDEX1, invalidRecipient, CLAIM_AMOUNT, index1Proof());
    }
        ...
        whenRecipientValid
    {
        ...
        vm.expectRevert(Errors.SablierMerkleBase_InvalidProof.selector);
        merkleBase.claim{ value: MINIMUM_FEE_IN_WEI }(INDEX1, users.recipient1, invalidAmount, index1Proof());
    }
    ...
    {
        vm.expectRevert(Errors.SablierMerkleBase_InvalidProof.selector);
        merkleBase.claim{ value: MINIMUM_FEE_IN_WEI }(INDEX1, users.recipient1, CLAIM_AMOUNT, index2Proof());
    }
