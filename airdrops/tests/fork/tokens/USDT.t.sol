...
import { MerkleExecute_Fork_Test } from "../merkle-campaign/MerkleExecute.t.sol";
...
contract USDT_MerkleExecute_Fork_Test is MerkleExecute_Fork_Test(usdt) { }
...
contract USDT_MerkleVCA_Fork_Test is MerkleVCA_Fork_Test(usdt) { }
