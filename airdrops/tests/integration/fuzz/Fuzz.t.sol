...
abstract contract Shared_Fuzz_Test is Integration_Test {
        ...
        givenMsgValueNotLessThanFee
    {
        ...
        for (uint256 i = 0; i < indexesToClaim.length; ++i) {
            ...
            // If `leafIndex` is even and the campaign type is not "vca" or "execute", use {claim} function.
            // We need the "recipient == msg.sender" condition.
            if (leafIndex % 2 == 0 && !Strings.equal(campaignType, "vca") && !Strings.equal(campaignType, "execute")) {
